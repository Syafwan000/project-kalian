        ...
        <div
            ...
            <div
                ...
                <button
                    ...
                    @click="project.setSeason(season.season)"
                    class="group relative w-full rounded-md bg-zinc-200 py-3 font-semibold shadow-sm shadow-black/20 overflow-hidden outline-none transition-all duration-150 hover:bg-zinc-400/30">
                    <svg class="absolute -left-4 -top-2 text-zinc-400/30 w-20 h-20 group-hover:text-zinc-100/50" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
